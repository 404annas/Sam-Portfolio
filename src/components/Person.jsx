...
const MarqueeContent = () => (
    <div className='flex items-center'>
        <span className='ibm text-xs font-medium text-first uppercase mx-4'>Data Scientist</span>
            ...
            <div className='bg-first noise-on-card w-[clamp(300px,30vw,380px)] h-[85vh] rounded-2xl flex flex-col overflow-hidden'>
                ...
                <div className='flex-grow custom-scrollbar overflow-y-auto'>
                    <div className='relative z-10 px-6 py-4'>
                        {/* Top Text */}
                        <h2 className='text-third text-[90px] text-center leading-none' style={{ fontFamily: '"Instrument Serif", serif' }}>
                            SAM
                            <br />
                            PATEL
                        </h2>
                    ...
                    {/* Marquee */}
                    <div className='relative z-10 bg-second py-3 mt-auto'>
