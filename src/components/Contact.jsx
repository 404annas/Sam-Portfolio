...
const MarqueeContent = () => (
    <div className='flex items-center'>
        <span className='ibm text-xs font-medium text-first uppercase mx-4'>Contact</span>
            ...
            <div className='flex-grow flex flex-col text-text-dark'>
                ...
                <div className='flex flex-col items-center text-center pt-8'>
                    ...
                    <div className='w-20 h-20 rounded-full bg-second flex items-center justify-center overflow-hidden'>
                        <img src={avatar} alt="Sam Patel" className='w-full h-full object-cover grayscale' />
                    </div>
                ...
                <div className='grid grid-cols-4 border-y border-black my-8'>
                    {socialLinks.map((link, index) => (
                        <a
                            ...
                            className={`flex items-center justify-center h-24 hover:bg-second hover:text-first transition-all duration-300 ${index < socialLinks.length - 1 ? 'border-r border-black' : ''}`}
                        >
                            {link.icon}
                        </a>
                    ))}
                ...
                <div className='flex flex-col items-center text-center flex-grow justify-center pb-8'>
                    ...
                    <p className='text-[32px] leading-none mt-2'>
                        HELLO@PATEL.COM
                    </p>
                </div>
